  ...
  _createClass(TimeAxis, [{
    ...
    value: function componentWillReceiveProps(nextProps) {
      var scale = nextProps.scale,
          ...
          formatFunction = nextProps.formatFunction;
    ...
    key: "renderTimeAxis",
    value: function renderTimeAxis(scale, format, formatFunction) {
      var axis = void 0;
      ...
      (0, _d3Selection.select)(_reactDom2.default.findDOMNode(this)) // eslint-disable-line
      .select("g").selectAll(".tick").select("text").style("fill", labelColor).style("stroke", "none").style("text-anchor", "end").attr("dx", "-.8em").attr("dy", ".15em").attr("transform", "rotate(-15)");
      (0, _d3Selection.select)(_reactDom2.default.findDOMNode(this)) // eslint-disable-line
...
TimeAxis.propTypes = {
  ...
  formatFunction: _react2.default.PropTypes.func,
